...
face_cascade = cv2.CascadeClassifier('detection_tete/haarcascade_frontalface_default.xml')
eye_cascade = cv2.CascadeClassifier('detection_tete/haarcascade_eye.xml')
...
def resize_image(img):
    scale_percent = 400 / img.shape[1] # percent of original size
    width = int(img.shape[1] * scale_percent )
    height = int(img.shape[0] * scale_percent)
    new_dim = (width, height)
    resized_image = cv2.resize(img, new_dim)
...
if __name__ == "__main__":
    ...
    img = cv2.imread('face_detection/3F2509DA0B68469280C4EC51E5661F6839CC295A.jpeg')    
    print(coordinate_face(img))
    #img = cv2.imread('dataset/Emmanuel Macron/3F2509DA0B68469280C4EC51E5661F6839CC295A.jpeg')
    #img=resize_image(img,(441,630))
    # img = cv2.imread('dataset/Zinedine Zidane/2AD8DD3D989844C8B693149D852CEFDD291CF636.jpeg')
