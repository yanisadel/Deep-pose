...
def face_cam(min_detection_confidence=0.5):
...
def face_img(path , min_detection_confidence=0.5):
  l={}
  with  mp.solutions.face_detection.FaceDetection(min_detection_confidence=0.5) as face_detection:
...
def face_vid(path ,min_detection_confidence=0.5):
...
face_img("C:\\Users\ETTAFS\Desktop\\f\\a.jpg")
